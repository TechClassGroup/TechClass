...
<template>
  <div
      class="select-none text-6xl font-light text-gray-800 tracking-wider p-4 bg-50 shadow-lg rounded-lg transition-all duration-300 hover:opacity-90 flex items-center justify-center h-full cursor-pointer gap-1"
  >
