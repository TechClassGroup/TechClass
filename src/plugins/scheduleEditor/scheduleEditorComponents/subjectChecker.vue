      ...
      <div class="space-y-4">
        ...
        <div class="flex items-center gap-2 pt-2">
          <input
              ...
              class="w-4 h-4 text-[#0078D4] rounded border-gray-300 focus:ring-[#0078D4]"
              type="checkbox"
              @change="(e) => handleUpdate('isActive', (e.target as HTMLInputElement).checked)"
          />
          <label class="text-sm text-gray-600">启用该科目</label>
        </div>
      </div>
    </div>
